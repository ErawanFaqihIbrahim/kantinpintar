...
<body>
    ...
    <div class="overlap-group3">
        ...
        <select class="dropdown overlap-group-12" name="test_redirect">
            <option value="loginpembeli" class="overlap-group-12" selected>PEMBELI</option>
            <option value="loginpenjual" class="overlap-group-12">PENJUAL</option>
        </select>
    ...
    <form action="('actionloginPembeli')" method="post">
        <div class="login">
            @csrf
            ...
            <div class="overlap-group-1">
                ...
                {{-- <div class="password poppins-normal-asparagus-14px">Password</div> --}}
        ...
        <div>
            <div class="group-155">
                <button name="masuk" type="submit" class="overlap-group1-2" style="border:none">
                    <div class="overlap-group1-1">Masuk</div>
                </button>
            </div>
        </div>
        <script>
